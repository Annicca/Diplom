...
export const MyStatements: FC = () => {
    ...
    const infinitedata = useInfiniteQuery<TPage<TStaement[]>, AxiosError>({...query(idUser), initialData: initialData})
    return(
        <PageLayout>
            ...
            <PaginationList 
                ...
                renderItem={(item: TStaement) => <Statement key={item.idStatement} statement={item} />}
            />
        </PageLayout>
    )
}